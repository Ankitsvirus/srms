                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Student Result Details (SHUATS)</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
<?php }
    ...
    ?>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table class="table table-hover table-bordered" border="2" width="100%">
                                                <thead>
...
<td style="text-align: center"><b><?php echo htmlentities($totlcount); ?></b>&nbsp/&nbsp<b><?php echo htmlentities($outof=($cnt-1)*100); ?></b>&nbsp/&nbsp(10 CGPA)</td>
                                                        </tr>
<tr>
<th scope="row" colspan="2" style="text-align: center">Percntage</th>           
<td style="text-align: center"><b><?php echo  htmlentities($totlcount*(100)/$outof); ?> %</b>&nbsp/&nbsp <b><?php echo  htmlentities(($totlcount*(100)/$outof)/10); ?> &nbsp CGPA</td>
</tr>
