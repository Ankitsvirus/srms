...
<li class="has-children">
 ...
 <li class="has-children">
                                        <a href="#"><i class="fa fa-graduation-cap"></i> <span>Result</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
...
<li class="has-children">
                                        ...
                                        <li><a href="view-form.php"><i class="fa fa-copy"></i> <span>View Form</span></a></li>
                                        <li><a href="view-feedback.php"><i class="fa fa-asl-interpreting"></i> <span>view Feedback</span></a></li>
                                        <li><a href="change-password.php"><i class="fa fa-key"></i> <span> Admin Change Password</span></a></li>
